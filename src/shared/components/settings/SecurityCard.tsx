          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Gestiona las credenciales de ingreso y protección de tu cuenta
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 pb-6 border-b border-gray-100">
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-2.5 bg-[#33C7BE] hover:bg-teal-600 text-white text-xs sm:text-sm font-semibold rounded-xl transition-all shadow-sm shadow-teal-500/20 cursor-pointer"
            >
          ...
          <div className="flex items-start justify-between opacity-60">
            ...
            <button
              disabled
              className="px-4 py-2 border border-gray-200 text-gray-400 text-xs font-semibold rounded-xl cursor-not-allowed"
            >
              Próximamente
            </button>
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-5 border-b border-gray-100">
              ...
              <p className="text-sm text-gray-600 mt-1">Asegúrate de usar una contraseña segura</p>
            </div>
