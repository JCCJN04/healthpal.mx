          ...
          <div className="grid lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_460px] gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-7 text-gray-500 text-[1.05rem] leading-relaxed max-w-[480px]">
                Guarda y comparte tu historial médico en segundos. Con
                WhatsApp integrado, compartir un estudio es tan fácil como
                mandar un mensaje.
              </p>
  ...
  return (
    <div className="relative lp-float">
      ...
      <div className="absolute -bottom-5 -left-5 lp-float-rev bg-white rounded-2xl shadow-xl border border-gray-100 px-3.5 py-2.5 flex items-center gap-2.5 z-20">
        ...
        <div>
          <p className="text-[11px] font-bold text-gray-900 leading-none">WhatsApp</p>
          <p className="text-[10px] text-gray-400 mt-0.5">Doc recibido · ahora</p>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div ref={ref} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {/* Card: WhatsApp */}
        <div
          className="bg-[#f0fdf4] border border-[#25D366]/20 shadow-sm rounded-3xl p-7 transition-all duration-700 ease-out"
          style={{ opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(28px)', transitionDelay: '160ms' }}
        >
          <WhatsAppIcon className="w-7 h-7 text-[#25D366] mb-5" />
          <h3 className="font-bold text-gray-900 mb-2 leading-snug">Manda por WhatsApp</h3>
          <p className="text-sm text-gray-500 leading-relaxed">
            Envía documentos al número de HealthPal sin tener cuenta. Los guardamos automáticamente en tu expediente.
          </p>
        </div>
...
function DoctorsSection() {
  ...
  const features = [
    ...
    { icon: MessageCircle, title: 'Solicita documentos por WhatsApp', desc: 'Pide estudios o resultados directamente por WhatsApp. El paciente responde con el archivo y llega solo a su expediente.' },
