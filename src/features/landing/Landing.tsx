...
function PageLoader() {
  ...
  useEffect(() => {
    ...
    const t2 = setTimeout(() => setGone(true), 400)
    return () => {
      clearTimeout(t1)
      clearTimeout(t2)
    }
...
function Navbar() {
  ...
  return (
    <header
      ...
      style={{
        backgroundColor: scrolled ? 'rgba(16,23,34,0.98)' : 'rgba(16,23,34,0.8)',
    ...
    >
      ...
      >
        <div className="px-6 pb-6 pt-3 space-y-1 border-t border-white/10">
          <a
            href="#plataforma"
            className="flex w-full py-3 text-sm font-medium text-white/70 hover:text-white transition-colors"
          >
            Plataforma
          </a>
          <a
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 text-center px-6 max-w-[1000px] mx-auto pt-[68px]">
        ...
        >
          Accesa al expediente de tus pacientes en segundos. Con WhatsApp integrado, enviar archivos
          es tan fácil como mandar un mensaje.
        </p>
    ...
    <section className="py-16 px-6" style={{ backgroundColor: '#f9f0ff' }}>
      <div className="max-w-[1100px] mx-auto">
        <div ref={ref} style={style}>
          <div
            className="rounded-[28px] px-6 py-14 sm:px-12 sm:py-20 md:px-20 md:py-28 text-center"
          ...
          >
            <WordReveal
              ...
              stagger={60}
            >
              Decenas de pacientes en WhatsApp. Tus pacientes te vuelven a preguntar lo mismo.
              Análisis perdidos entre fotos y mensajes.
            </WordReveal>
          </div>
        </div>
      </div>
...
function SpeedSection() {
  ...
  return (
    <section
      id="como-funciona"
      className="pt-8 pb-0 overflow-hidden"
    ...
    >
      <div className="max-w-[1100px] mx-auto px-6">
        <div ref={titleRef} style={titleStyle} className="text-center">
          <h2 className="text-[3.5rem] sm:text-[5rem] md:text-[6.5rem] font-black leading-[0.95] tracking-[-0.04em] mb-6">
            <span
              ...
              style={{
                backgroundImage: 'linear-gradient(90deg, #ff3eb5 0%, #8b3fff 30%, #0097a9 100%)',
              }}
            >
        ...
        <div ref={mockupRef} style={mockupStyle} className="relative mt-4 pb-0">
          ...
          <div
            className="lp-float hidden md:block absolute left-[2%] top-[10%] w-12 h-12 rounded-full opacity-60"
            style={{ background: 'linear-gradient(135deg, #8b3fff, #4541fe)' }}
          />
          <div
            className="lp-float-alt hidden md:block absolute left-[9%] top-[55%] opacity-55"
            style={{
              width: 0,
              height: 0,
              borderLeft: '14px solid transparent',
              borderRight: '14px solid transparent',
              borderBottom: '26px solid #ff3eb5',
            }}
          />
          <div
            className="lp-float-rev hidden md:block absolute right-[5%] top-[8%] w-10 h-10 rounded-full opacity-50"
            style={{ background: 'linear-gradient(135deg, #ff3eb5, #8b3fff)' }}
          />
  ...
  return (
    <div className="shadow-[0_40px_80px_rgba(0,0,0,0.12)] rounded-t-xl overflow-hidden w-full">
      ...
      <div className="bg-[#1e1e2e] px-4 py-2.5 flex items-center gap-3">
        ...
        <div className="flex-1 bg-[#2a2a3e] rounded h-6 flex items-center px-3 text-[10px] text-white/30 min-w-0">
          healthpal.mx/dashboard
        </div>
      </div>
  ...
  return (
    <section className="bg-white overflow-hidden">
      <div
        ref={ref}
        style={style}
        className="max-w-[1200px] mx-auto grid lg:grid-cols-2 items-center gap-0"
      >
        ...
        <div className="px-10 py-16 lg:px-16 lg:py-20">
          ...
          <p className="text-[15px] leading-relaxed mb-8 text-[#666] max-w-[540px]">
            Gestiona expedientes, agenda citas y comparte documentos médicos con tus pacientes —
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <svg viewBox="0 0 800 700" className="absolute left-0 top-0 h-full w-auto opacity-25">
          ...
          <path
            ...
            d="M -100 300 Q 100 150 250 200 Q 400 250 350 400 Q 300 550 150 600 Q 0 650 -100 500 Z"
            fill="url(#aiRib)"
            opacity="0.9"
          />
        </svg>
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-24 relative z-10">
        <div ref={ref} style={style} className="text-center">
          ...
          <p
            className="text-[15px] max-w-[460px] mx-auto mb-14"
            style={{ color: '#101722', opacity: 0.55 }}
          >
            Tu información médica protegida con cifrado AES-256, diseñada conforme a la NOM-024-SSA3
            y sin acceso de terceros. Lo que es tuyo, es tuyo.
          </p>
        </div>
      </div>
    </section>
...
function ScaleSection() {
  ...
  return (
    <section className="overflow-hidden relative py-24" style={{ backgroundColor: '#4541fe' }}>
      <div
        className="lp-float absolute left-[4%] top-[18%] w-20 h-20 rounded-full opacity-15"
        style={{ background: 'linear-gradient(135deg, #ff3eb5, white)' }}
      />
      <div
        className="lp-float-rev absolute right-[7%] bottom-[12%] opacity-15"
        style={{
          width: 0,
          height: 0,
          borderLeft: '30px solid transparent',
          borderRight: '30px solid transparent',
          borderBottom: '52px solid #ff3eb5',
        }}
      />
      ...
      <div className="max-w-[1100px] mx-auto px-6 relative z-10">
        ...
        <div ref={ref} style={style} className="text-center mb-12">
          <p className="text-white/60 text-[14px] mb-6 max-w-[560px] mx-auto leading-relaxed">
            Menos tiempo en papeleo, más tiempo con pacientes. Médicos en México ahorran hasta 2
            horas diarias con HealthPal.
          </p>
          <Link to="/register">
        ...
        <div
          ref={statsRef}
          className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/15 mb-10 rounded-xl overflow-hidden"
        >
          {[
            [c1.toLocaleString(), 'Pacientes activos'],
            [c2.toLocaleString(), 'Consultas este mes'],
            [c3.toLocaleString(), 'Documentos subidos'],
          ].map(([v, l]) => (
            <div key={l} className="py-8 px-6 text-center" style={{ backgroundColor: '#4541fe' }}>
              <p className="text-[2.5rem] md:text-[3.5rem] font-black text-white leading-none tracking-[-0.04em]">
                {v}
              </p>
        ...
        <div className="rounded-t-2xl overflow-hidden shadow-[0_-20px_60px_rgba(0,0,0,0.25)]">
          <div className="bg-[#0f0e19] px-4 py-2.5 flex items-center gap-3">
            ...
            <div className="flex-1 bg-white/10 rounded h-5 flex items-center px-3 text-[9px] text-white/30">
              healthpal.mx
            </div>
          </div>
...
const TESTIMONIALS = [
  {
    source: '🟢',
    platform: 'WhatsApp',
    name: 'Dra. Alejandra R.',
    location: 'CDMX',
    stars: 5,
    text: 'Mis pacientes me mandan sus estudios por WhatsApp y los tengo listos antes de que lleguen a consulta. HealthPal cambió completamente mi flujo de trabajo.',
  },
  {
    source: '⭐',
    platform: 'App Store',
    ...
    stars: 5,
    text: 'Tenía años buscando una plataforma así. Subí todos mis estudios en una tarde y ahora los comparto con cualquier médico en segundos.',
  },
  {
    source: '🔵',
    ...
    location: 'Monterrey',
    stars: 5,
    text: 'La agenda integrada y el expediente en un solo lugar es un antes y un después. Ya no pierdo tiempo buscando archivos entre consulta y consulta.',
  },
  {
    source: '🟢',
    platform: 'WhatsApp',
    ...
    location: 'Puebla',
    stars: 5,
    text: 'Llevaba mis estudios en una bolsa de plástico desde hace 10 años. Ahora los tengo todos aquí y los puedo compartir con mi médico con un tap.',
  },
  {
    source: '⭐',
    platform: 'App Store',
    ...
    location: 'Querétaro',
    stars: 5,
    text: 'Lo que más me gusta es que mis pacientes llegan con su historial completo. Dedico menos tiempo a preguntas básicas y más a lo que importa.',
  },
  {
    source: '🔵',
    platform: 'Google Play',
    ...
    location: 'CDMX',
    stars: 5,
    text: 'Encontré a mi médico en el directorio, agendé la cita el mismo día y compartí mis análisis antes de llegar. Todo desde el celular. Increíble.',
  },
]
...
function TestimonialsSection() {
  ...
  useEffect(() => {
    const update = () =>
      setCardW(window.innerWidth < 640 ? Math.min(320, window.innerWidth - 48) : 320)
    update()
            ...
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    <p className="text-[13px] font-bold" style={{ color: '#101722' }}>
                      {t.name}
                    </p>
        ...
        <div className="flex gap-2 mt-6">
          {[...Array(max + 1)].map((_, i) => (
            <button
              ...
              style={{
                width: offset === i ? '32px' : '8px',
                backgroundColor: offset === i ? '#4541fe' : '#ccc',
              }}
            />
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-8 md:gap-10 mb-14">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-[13px] text-gray-500 leading-relaxed max-w-[200px]">
              Expediente clínico digital para médicos y pacientes. Hecho en México 🇲🇽
            </p>
          </div>
          <div>
            <p className="text-[13px] font-black mb-4" style={{ color: '#101722' }}>
              Legal
            </p>
            <Link
              to="/privacidad"
              className="block text-[13px] mb-2.5 hover:text-[#0097a9] transition-colors"
              style={{ color: '#0097a9' }}
            >
              Aviso de Privacidad
            </Link>
  ...
  '@graph': [
    {
      ...
      description:
        'Plataforma de expediente clínico electrónico para médicos y centralización de documentos médicos para pacientes en México. Gratis.',
      inLanguage: 'es-MX',
    ...
    },
    {
      ...
      description:
        'Software de expediente clínico electrónico y gestión de documentos médicos para médicos y pacientes en México.',
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'HealthPal.mx es una plataforma digital gratuita para médicos y pacientes en México. Los médicos gestionan expedientes clínicos electrónicos, agenda y comunicación con pacientes. Los pacientes centralizan todos sus documentos médicos en un solo lugar seguro y accesible desde cualquier dispositivo.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Con HealthPal.mx puedes digitalizar tu consultorio en minutos: crea una cuenta gratis, registra tus pacientes y gestiona expedientes clínicos electrónicos, agenda de citas y comunicación por WhatsApp desde un solo lugar. No requiere tarjeta de crédito.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'HealthPal.mx te permite centralizar todos tus documentos médicos: laboratorios, radiografías, tomografías, recetas y estudios, de forma segura y accesible desde tu celular. Es gratis para pacientes en México.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Sí. HealthPal.mx es gratuito para médicos generales y especialistas en México. Incluye expediente clínico electrónico completo, agenda médica digital y WhatsApp integrado para compartir documentos con pacientes.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Con HealthPal.mx puedes compartir documentos médicos directamente con tu médico desde la plataforma o por WhatsApp integrado. Los archivos se envían cifrados y solo tu médico y tú tienen acceso.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'HealthPal.mx está diseñado conforme a los lineamientos de la NOM-024-SSA3, la norma oficial mexicana para sistemas de información en salud. Todos los datos médicos se almacenan con cifrado AES-256 y acceso estrictamente controlado por rol.',
          },
        },
      ],
    },
...
export default function Landing() {
  ...
  return (
    <div style={{ backgroundColor: '#f9f0ff', overflowX: 'hidden' }}>
      <Helmet>
        <title>
          HealthPal.mx — Expediente clínico electrónico para médicos y pacientes en México
        </title>
        <meta
          name="description"
          content="Médicos: digitaliza tu consultorio con expediente clínico electrónico, agenda y WhatsApp. Pacientes: centraliza tus documentos médicos en un solo lugar. Gratis en México."
        />
        <meta
          name="keywords"
          content="expediente clínico electrónico México, software expediente médico gratis, centralizar documentos médicos paciente, historial médico digital México, agenda médica digital, documentos médicos en la nube, plataforma médico paciente México"
        />
        <link rel="canonical" href="https://healthpal.mx/" />
        <meta
          property="og:title"
          content="HealthPal.mx — Expediente clínico electrónico para médicos y pacientes en México"
        />
        <meta
          property="og:description"
          content="Médicos: digitaliza tu consultorio gratis. Pacientes: centraliza tus documentos médicos. Todo en un solo lugar."
        />
