...
async function fetchAppointments(doctorId: string): Promise<AppointmentWithPatient[]> {
  ...
  if (error) {
    logger.error('assistant:fetchAppts', error)
    return []
  }
...
export default function AssistantDashboard() {
  ...
  useEffect(() => {
    linkPendingInvitations()
      ...
      .catch((err) => {
        logger.error('AssistantDashboard.linkPendingInvitations', err)
      })
      .finally(() => {
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-1">
                    ...
                    <span
                      className={`text-[10px] font-semibold px-2 py-0.5 rounded-full border ${STATUS_STYLES[nextAppt.status]}`}
                    >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <span
                          className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full border ${STATUS_STYLES[appt.status]}`}
                        >
