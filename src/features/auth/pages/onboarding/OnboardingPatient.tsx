    ...
    try {
      ...
      if (insurance.provider_name) {
        await upsertInsurance(userId, {
          ...
          provider_other:
            insurance.provider_name === 'Otro' ? insurance.provider_other || null : null,
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 mb-6 text-sm text-blue-800 leading-relaxed shadow-sm">
          <strong>Privacidad y Cifrado Activo:</strong>
          <br />
          Tus campos paramétricos sensibles (como alergias y condiciones) se configurarán de forma
          encriptada (<span className="opacity-90">End-to-End</span>) en tu primera consulta con tu
          médico autorizado.
        </div>
          ...
          {insurance.provider_name === 'Otro' && (
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setInsurance((prev) => ({ ...prev, provider_other: e.target.value }))
                }
            ...
            <div className="space-y-3 bg-gray-50 rounded-xl p-4 border border-gray-100">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setInsurance((prev) => ({ ...prev, policy_number: e.target.value }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setInsurance((prev) => ({ ...prev, holder_name: e.target.value }))
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setInsurance((prev) => ({ ...prev, holder_relationship: e.target.value }))
                  }
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#33C7BE]/40 focus:border-[#33C7BE]"
                >
