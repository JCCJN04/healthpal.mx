...
type TabId = 'consultas' | 'recetas' | 'documentos'
...
export default function DoctorDetail() {
  ...
  const storedCoords =
    loc && typeof loc.lat === 'number' && typeof loc.lng === 'number' ? loc : null
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                                <span className="flex items-center gap-1 text-xs text-gray-500">
                                  {statusIcon} {statusLabel[appt.status] ?? appt.status}
                                </span>
                                <span className="text-gray-300">·</span>
                                <span className="text-xs text-gray-500">
                                  {modeLabel[appt.mode] ?? appt.mode}
                                </span>
                                {appt.reason && (
                                  <>
                                    <span className="text-gray-300">·</span>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mt-1 ${statusColor[appt.status] ?? 'bg-gray-100 text-gray-600'}`}
              >
